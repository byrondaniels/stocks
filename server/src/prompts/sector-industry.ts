/**
 * Sector and Industry Classification Prompt
 * Uses Gemini to classify stocks into sectors and industries
 */

/**
 * Builds the prompt for Gemini to classify sector and industry
 *
 * Asks Gemini to identify the broad sector and most specific industry
 * for a given stock ticker, with comprehensive industry options mapped
 * to corresponding sector ETFs.
 *
 * @param ticker - Stock ticker symbol
 * @returns Formatted prompt for Gemini API
 *
 * @example
 * const prompt = buildSectorIndustryPrompt('NVDA');
 * // Returns prompt asking for sector/industry classification
 */
